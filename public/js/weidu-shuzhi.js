...
// 获取维度-===========================================================
    $('#sure-weidu').click(function(){
        $.ajax({
            ...
            dataType : "json",
            success: function(data){
                // option1.legend.data=['1','3'];
                // alert(option1.legend.data);
                //给option1设置图例名字
            ...
            complete:function(result){
                ...
                // 调用方法，给那些series赋值
                setdata(item,result,option.series[0].type);
                myChart.setOption(option);
            },
            error:function(errorMsg){
                alert("请求数据失败");
...
// 获取数值===========================================================
    ...
    //                  option1.legend.data = result[i]['name'];
    //              }
    ...
    //          });
       ...
       //           })
                ...
                $('.yanse2-chose .refresh').click(function(){
                    // 修改饼图的颜色设置
                    for(var i=0;i<arr_color2.length;i++){
                ...
                $('.yanse3-chose .refresh').click(function(){
                    // 修改关系图的颜色设置
                    for(var i=0;i<arr_color3.length;i++){
                ...
                $('.yanse4-chose .refresh').click(function(){
                    // 修改漏斗图的颜色设置
                    for(var i=0;i<arr_color4.length;i++){
...
// 动态的添加数据
  ...
  function setdata(item,data){
    for(var i=0;i<data.length;i++){
        ...
        // option1.legend.data[i] = data[i]['name'];
        // alert(data[i]['name']);
    }
